...
<% try
	{
 	j=st.executeUpdate("delete from matrimonial_det where mailid='"+jcodedel+"'");
	if(j>0)
	{	
		%>             
    ...
    background="images/17.jpg"></TD></TR>
        <TR>
		  ...
		  <br><br>
            ...
            <% response.setHeader("Refresh","3;URL=matrimonydesc.html"); %>
          </TD></TR>
        <TR>
          <TD vAlign=top width=771 
    >&nbsp;
...
<TR>
    ...
    >
            ...
            <% response.setHeader("Refresh","3;URL=jobcode5.html"); %>
          </TD></TR>
        <TR>
          <TD vAlign=top width=771 
    >&nbsp;
